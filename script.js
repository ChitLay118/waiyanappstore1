document.addEventListener('DOMContentLoaded', () => {
    ...
    const dummyApps = [
        ...
        {id:24,name:'MoviesHub',description:''ဗီဒီယိုများ ကြည့်ရှုရန်',size:'21.2 MB',rating:4.5,category:'Entertainment',isFeatured:false,iconUrl:'https://i.ibb.co/1G1CxCvL/photo-2025-09-18-11-23-30.jpg',downloadUrl:'https://www.mediafire.com/file/sek461p93u6xi9n/MOVIES_HUB_PREMIUM_v2.3.8d_Modded_by_%2540Getmodpcs.apk/file'},        
        {id:25,name:'live Flight Tracker',description:'modversion',size:'21.2 MB',rating:4.5,category:'Modified Apps',isFeatured:false,iconUrl:'https://i.ibb.co/gbwHMvvg/photo-2025-09-18-11-23-01.jpg',downloadUrl:'https://www.mediafire.com/file/qn1g8vmh5e6tisf/FLYMAT_PREMIUM_v1.0.75_Modded_by_%2540Getmodpcs.apk/file'},
